...
<button onclick="gotopage(11)">11</button>
<button onclick="gotopage(12)">12</button>
<button onclick="gotopage(13)">13</button>
<button onclick="gotopage(14)">14</button>
<button onclick="gotopage(15)">15</button>
<button onclick="gotopage(16)">16</button>
<button onclick="gotopage(17)">17</button>
<button onclick="gotopage(18)">18</button>
<button onclick="gotopage(19)">19</button>
<button onclick="gotopage(20)">20</button>
</div>
`
...
// username  = datas.map((ele)=>ele.name);
// email = datas.map((ele)=>ele.email);
// id = datas.map((ele)=>ele.id);
// first_username = username.slice(0,9)
...
// value?pagesize = value:null;

  pageNumber--;

pageNumber*pagesize;
let filteredData =  datas.filter((item)=>{
 return item.id>=pageNumber*pagesize && item.id<=pageNumber*pagesize + pagesize;
})
let page = document.getElementById("data");
populatePage(page,filteredData);
console.log(filteredData);
}


function populatePage(ele,data){
  ele.innerHTML = "";
